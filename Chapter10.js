...
function replaceIt() {
    ...
    var theStory = "<h1>Petros Coding Story</h1>";
    theStory += "Last year one " + adj1 + " day, Petros was " + verbIng + " in his " + roomInHouse + ", coding a JavaScrip programm " + color + " " + nounPlural + ".<br><br>";
    ...
    theStory += "Petros coded the " + animal + " Dance, the " + city + " Code, and took the prize for coding the best JavaScrip App " + verb + ".<br><br>";
